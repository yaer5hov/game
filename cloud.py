...
class Ball(object):
    ...
    def draw(self):
        ...
        pygame.draw.circle(screen,(255, 255, 0) , (self._xLoc,self._yLoc), self._radius)
...
class Paddle (object):
    ...
    def draw(self):
        ...
        pygame.draw.rect(screen, (255,255,255), (self._xLoc,self._yLoc,self._width,self._height),0)
    def update(self):
